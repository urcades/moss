...
/usr/libexec/PlistBuddy -c "Add :CFBundleShortVersionString string 0.3.1" "$APP/Contents/Info.plist"
...
/usr/libexec/PlistBuddy -c "Add :CFBundleShortVersionString string 0.3.1" "$HELPER/Contents/Info.plist"
/usr/libexec/PlistBuddy -c "Add :CFBundleVersion string 4" "$HELPER/Contents/Info.plist"
...
/usr/libexec/PlistBuddy -c "Add :CFBundleShortVersionString string 0.3.1" "$BROKER/Contents/Info.plist"
/usr/libexec/PlistBuddy -c "Add :CFBundleVersion string 4" "$BROKER/Contents/Info.plist"
