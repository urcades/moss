...
/usr/libexec/PlistBuddy -c "Add :CFBundleShortVersionString string 0.3.2" "$APP/Contents/Info.plist"
...
/usr/libexec/PlistBuddy -c "Add :CFBundleShortVersionString string 0.3.2" "$HELPER/Contents/Info.plist"
/usr/libexec/PlistBuddy -c "Add :CFBundleVersion string 5" "$HELPER/Contents/Info.plist"
...
/usr/libexec/PlistBuddy -c "Add :CFBundleShortVersionString string 0.3.2" "$BROKER/Contents/Info.plist"
/usr/libexec/PlistBuddy -c "Add :CFBundleVersion string 5" "$BROKER/Contents/Info.plist"
