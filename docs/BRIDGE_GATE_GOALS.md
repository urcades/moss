...
- Current status:
  ...
  - Latest `swift run codexmsgctl-swift doctor --probe-computer-use` returned without hanging and failed visibly with marker `CODEX_DOCTOR_COMPUTER_USE_F475AC28-76DF-4681-946C-CED9F7966CF4` and exact blocker `Computer Use server error -10005: cgWindowNotFound`.
